...
export default {
    ...
    mounted() {
        const produk_slug = this.$route.params.slug;
        console.log("Fetching single product with Slug:", produk_slug);
        this.fetchSingleProduk(produk_slug);
